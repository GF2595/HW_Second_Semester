...
namespace ListNamespace
{
    ...
    public class _List
    {
        ...
        {
            internal Element Value { get; set; }
        ...
        public void PlaceElement(Element value, int position)
        {
            if (position == 0)
            {
                ListElement newElement = new ListElement
        ...
        public Element CheckElement(int position)
        {
            if (position > this.length)
            {
        ...
        public int FindElement(Element value)
        {
            if (this.head != null)
            {
                ListElement currentElement = this.head;
